...
#define TOKENS_RE         "->|=|<>|!!|&&|\\|\\||+|-|*|DIV|MOD|LT|GT|\\(|\\)|\\{|\\}|\\[|\\]|,|;|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       "->|=|<>|!!|&&|\\|\\||+|-|*|DIV|MOD|LT|GT|\\(|\\)|\\{|\\}|\\[|\\]|,|;|PROGRAM|VAR|BEGIN|END|INPUT|OUTPUT|IF|ELSE|REPEAT|UNTIL|INT_2"
...
#define DEFAULT_INPUT_FILE "D05_1.txt"
